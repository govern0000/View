class Frame : Any
{
    ...
    maide private Bool PrivatePointerEvent(var Int index, var Int value)
    {
        var Bool b;
        b : index = 4 | index = 5;
        ...
        this.PointerEvent(index, valueK);
        return true;
    }
    ...
    maide precate Bool PointerEvent(var Int index, var Any value)
    {
    }
